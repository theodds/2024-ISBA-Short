...
In this document, we illustrate the use of the proportional hazards model applied with BART to survival analysis. The
dataset we are interested is described in the `spBayesSurv` package as follows:
...
We use a slightly modified version of this dataset, with the covariates of interest scaled:
